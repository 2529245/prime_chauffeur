...
@section('header', 'Staff Documents')
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="header-actions">
                <a href="{{ route('documents.staff.create') }}" class="btn btn-primary">
    ...
    <div class="table-card">
        ...
        <div class="table-responsive">
            <table class="modern-table" id="documentsTable">
                <thead>
                    <tr>
                        <th data-sort="staff"><span>Staff</span><i class="fas fa-sort"></i></th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <strong>{{ $document->staff->name }}</strong>
                            <br>
                            <small class="text-muted">{{ $document->staff->position }}</small>
                        </td>
                        <td>
                        ...
                        <td>
                            <div class="action-buttons">
                                       @php
    $member = $document->staff->id;
@endphp
                                <a href="{{ route('staff.show', $member) }}" 
                                   class="btn-action btn-info" title="View Staff">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('documents.staff.download', $document) }}" 
                                   class="btn-action btn-primary" 
                                   title="Download Document">
                                    <i class="fas fa-download"></i>
                                </a>
                                <a href="{{ route('documents.staff.edit', $document) }}" 
                                ...
                                <button class="btn-action btn-danger document-delete-trigger" 
                                        ...
                                        data-documentname="{{ $document->staff->name }} - {{ ucfirst(str_replace('_', ' ', $document->document_type)) }}">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.document-delete-trigger').forEach(button => {
        button.addEventListener('click', function() {
            ...
            deleteDocumentForm.action = "{{ route('documents.staff.destroy', ':id') }}".replace(':id', currentDocumentId);
