...
@section('header', 'Upload Driver Document')
...
<div class="documents-container">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('documents.driver.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                               ...
                               <select class="form-control select2 @error('driver_id') is-invalid @enderror" id="driver_id" name="driver_id" required>
    <option value="">Select Driver</option>
    @foreach($drivers as $driver)
        <option value="{{ $driver->id }}" 
            {{ old('driver_id', request('driver_id')) == $driver->id ? 'selected' : '' }}>
    ...
    @endforeach
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('document_type') is-invalid @enderror" 
                                        ...
                                        <option value="rta_card" {{ old('document_type') == 'rta_card' ? 'selected' : '' }}>RTA Card</option>
                                        <option value="visa" {{ old('document_type') == 'visa' ? 'selected' : '' }}>Visa</option>
                                        <option value="home_country_id" {{ old('document_type') == 'home_country_id' ? 'selected' : '' }}>Home Country ID</option>
                                    </select>
                                    @error('document_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="form-actions mt-4">
                            <div class="d-flex justify-content-end align-items-center">
                                <a href="{{ route('documents.driver.index') }}" class="btn btn-secondary mr-2">
                                    Cancel
                                </a>
