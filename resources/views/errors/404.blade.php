...
<div class="error-container">
    <div class="error-content">
        ...
        <p class="error-description">It seems like you're trying to access a page that has been moved or doesn't exist.</p>
...
<body>
    ...
    <div class="error-container">
        ...
        <h1 class="error-title">Page Not Found</h1>
        <p class="error-message">The page you're looking for doesn't exist.</p>
        <p class="error-description">Please check the URL or return to the login page.</p>
