...
@section('header', 'SIM Card Details')
...
<div class="assets-container">
    ...
    <div class="page-header mb-4">
        <div class="d-flex justify-content-between align-items-center">
            <h1 class="page-title">
                <i class="fas fa-sim-card"></i> SIM Card: {{ $simCard->sim_number }}
            </h1>
            ...
            <div class="header-actions">
                ...
                <a href="{{ route('assets.sim-cards.edit', $simCard->id) }}"
        ...
        <div class="col-lg-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="detail-item">
                                ...
                                <span>{{ $simCard->telecom_provider ?? 'N/A' }}</span>
                            </div>

                            <div class="detail-item">
                                <label>Package Amount:</label>
                                <span>{{ $simCard->plan_details ?? 'N/A' }}</span>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="detail-item">
                                ...
                                <span>
                                    {{ $simCard->created_at->format('M d, Y h:i A') }}
                                </span>
                            </div>
                            ...
                            <div class="detail-item">
                                ...
                                <span>
                                    {{ $simCard->updated_at->format('M d, Y h:i A') }}
                                </span>
                            </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    @if($simCard->assetAssignments->count() > 0)
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered table-hover w-100 text-white">
                                ...
                                <tbody>
                                    ...
                                    @foreach($simCard->assetAssignments as $assignment)
                    ...
                    @else
                        ...
                        <div class="text-center text-muted">
                            <p>No assignment history found for this SIM card</p>
                        </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-header {{ $currentAssignment ? 'bg-success' : 'bg-secondary' }} text-white">
                    ...
                    <h5 class="card-title mb-0">
                        <i class="fas fa-user-check"></i> Current Assignment
                    </h5>
                ...
                <div class="card-body">
                    ...
                    @else
                        ...
                        <div class="text-center text-muted">
                            <p>
                                This SIM card is not currently assigned to anyone
                            </p>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        @if(!$currentAssignment)
                            ...
                            <button
                                type="button"
                                class="btn btn-primary btn-block assign-sim-trigger"
                            >
                        ...
                        @else
                            ...
                            {{-- Return SIM card --}}
                            <form
                                action="{{ route('assets.return', $currentAssignment->id) }}"
                                method="POST"
                                class="d-grid"
                            >
                                ...
                                <button
                                    ...
                                    onclick="return confirm('Are you sure you want to return this SIM card?')"
                                >
                        ...
                        {{-- Delete SIM card --}}
                        <form
                            action="{{ route('assets.sim-cards.destroy', $simCard->id) }}"
                            method="POST"
                            class="d-grid"
                        >
                            ...
                            <button
                                ...
                                onclick="return confirm('Are you sure you want to delete this SIM card?')"
                            >
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const assignModal = document.getElementById('assignSimModal');
    ...
    document.querySelectorAll('.assign-sim-trigger').forEach(function (button) {
    ...
    if (assignableType) {
        ...
        assignableType.addEventListener('change', function () {
            ...
            assignableId.disabled = !type;


            /* Choose matching data */
            ...
            data.forEach(function (item) {
                ...
                let displayText = item.name || 'Unknown';
...
.form-control:focus {
    ...
    box-shadow:
        0 0 0 2px rgba(78, 205, 196, 0.25);
