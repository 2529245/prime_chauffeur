...
@section('title', 'Create SIM Card')
@section('header', 'Create SIM Card')
...
<div class="assets-container">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('assets.sim-cards.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('sim_number') is-invalid @enderror" 
                                           id="sim_number" name="sim_number" value="{{ old('sim_number') }}" required
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('telecom_provider') is-invalid @enderror" 
                                        ...
                                        <option value="Etisalat" {{ old('telecom_provider') == 'Etisalat' ? 'selected' : '' }}>Etisalat</option>
                                        <option value="Du" {{ old('telecom_provider') == 'Du' ? 'selected' : '' }}>Du</option>
                                        <option value="Virgin Mobile" {{ old('telecom_provider') == 'Virgin Mobile' ? 'selected' : '' }}>Virgin Mobile</option>
                                        <option value="Other" {{ old('telecom_provider') == 'Other' ? 'selected' : '' }}>Other</option>
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('plan_details') is-invalid @enderror" 
                                           id="plan_details" name="plan_details" value="{{ old('plan_details') }}">
                                    @error('plan_details')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('activation_date') is-invalid @enderror" 
                                           id="activation_date" name="activation_date" value="{{ old('activation_date') }}">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('notes') is-invalid @enderror" 
                                              id="notes" name="notes" rows="3" placeholder="Any additional notes about this SIM card">{{ old('notes') }}</textarea>
                                    @error('notes')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
