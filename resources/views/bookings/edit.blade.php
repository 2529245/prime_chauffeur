                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group" style="padding: 0 10px;">
                                                ...
                                                <input type="tel"
                                                       ...
                                                       value="{{ old('guest_contact_number', $booking->guest_contact_number) }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group" style="padding: 0 10px;">
                                                ...
                                                <input type="datetime-local"
                                                       ...
                                                       id="pick_up_time"
                                                       name="pick_up_time"
                                                       value="{{ old('pick_up_time', \Carbon\Carbon::parse($booking->pick_up_time)->format('Y-m-d\TH:i')) }}"
                                                       required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group" style="padding: 0 10px;">
                                                ...
                                                <input type="datetime-local"
                                                       ...
                                                       id="drop_off_time"
                                                       name="drop_off_time"
                                                       value="{{ old('drop_off_time', $booking->drop_off_time ? \Carbon\Carbon::parse($booking->drop_off_time)->format('Y-m-d\TH:i') : '') }}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group" style="padding: 0 10px;">
                                                ...
                                                <textarea class="form-control @error('pick_up_location') is-invalid @enderror"
                                                          id="pick_up_location"
                                                          name="pick_up_location"
                                                          rows="2"
                                                          required>{{ old('pick_up_location', $booking->pick_up_location) }}</textarea>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group" style="padding: 0 10px;">
                                                ...
                                                <textarea class="form-control @error('drop_off_location') is-invalid @enderror"
                                                          id="drop_off_location"
                                                          name="drop_off_location"
                                                          rows="2">{{ old('drop_off_location', $booking->drop_off_location) }}</textarea>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="form-group" style="padding: 0 10px;">
                                                ...
                                                <textarea class="form-control @error('special_instructions') is-invalid @enderror"
                                                          ...
                                                          rows="4">{{ old('special_instructions', $booking->special_instructions) }}</textarea>
                                            ...
                                            <div class="form-group" style="padding: 0 10px;">
                                                ...
                                                <select class="form-control @error('status') is-invalid @enderror"
                                                    ...
                                                    <option value="in_progress"
                                                        {{ old('status', $booking->status) == 'in_progress' ? 'selected' : '' }}>
                                                        In Progress
                                                    </option>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group" style="padding: 0 10px;">
                                                ...
                                                <input type="number"
                                                       ...
                                                       id="basic_amount"
                                                       name="basic_amount"
                                                       value="{{ old('basic_amount', $booking->basic_amount) }}"
                                                       required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group" style="padding: 0 10px;">
                                                ...
                                                <input type="number"
                                                       ...
                                                       value="{{ old('no_of_extra_hrs', $booking->no_of_extra_hrs ?? 0) }}"
                                                       min="0">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group" style="padding: 0 10px;">
                                                ...
                                                <input type="number"
                                                       ...
                                                       value="{{ old('extra_hrs_amount', $booking->extra_hrs_amount ?? 0) }}"
                                                       min="0">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group" style="padding: 0 10px;">
                                                ...
                                                <input type="number"
                                                       ...
                                                       id="other_amounts"
                                                       name="other_amounts"
                                                       value="{{ old('other_amounts', $booking->other_amounts ?? 0) }}"
                                                       min="0">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group" style="padding: 0 10px;">
                                                ...
                                                <input type="number"
                                                       ...
                                                       id="gross_total"
                                                       name="gross_total"
                                                       value="{{ old('gross_total', $booking->gross_total ?? 0) }}"
                                                       readonly>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group" style="padding: 0 10px;">
                                                ...
                                                <select class="form-control @error('payment_method') is-invalid @enderror"
                                                    ...
                                                    <option value="credit"
                                                        {{ old('payment_method', $booking->payment_method) == 'credit' ? 'selected' : '' }}>
                                                        Credit
                                                    </option>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    |--------------------------------------------------------------------------
    |
    | Same calculation as CREATE page:
    |
    | Total =
    | Basic Amount
    | + Extra Hours Amount
    | + Other Amounts
    |
    | Extra Hours itself does NOT calculate the amount.
    |
    */

    function calculateTotal() {

        const basicAmountElement =
            document.getElementById('basic_amount');

        const extraHrsAmountElement =
            document.getElementById('extra_hrs_amount');

        const otherAmountsElement =
            document.getElementById('other_amounts');

        const grossTotalElement =
        ...
        const basicAmount =
            parseFloat(basicAmountElement?.value) || 0;

        const extraHrsAmount =
            parseFloat(extraHrsAmountElement?.value) || 0;

        const otherAmounts =
            parseFloat(otherAmountsElement?.value) || 0;
    ...
    if (bookingForm) {
        ...
        bookingForm.addEventListener('submit', function (e) {
            ...
            const dropoffElement =
                document.getElementById('drop_off_time');


            if (!pickupElement || !dropoffElement) {
                return;
            }
            ...
            if (
                ...
                const pickupTime =
                    new Date(pickupElement.value);

                const dropoffTime =
                    new Date(dropoffElement.value);
